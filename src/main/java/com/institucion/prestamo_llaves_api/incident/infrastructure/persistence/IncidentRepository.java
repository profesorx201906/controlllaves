...
public interface IncidentRepository
    ...
    /**
     * Retorna los identificadores de los préstamos que tienen
     * una incidencia abierta.
     *
     * Se utiliza para enriquecer una página de préstamos
     * realizando una única consulta adicional.
     */
    @Query("""
            SELECT DISTINCT incident.loan.id
            FROM Incident incident
            WHERE incident.resolvedAt IS NULL
              AND incident.loan.id IN :loanIds
            """)
